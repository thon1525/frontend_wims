    ...
    return (
        <div className="lg:flex lg:h-full lg:flex-col">
            <header className="flex items-center justify-between border-b border-gray-200 py-4 lg:flex-none">
                <h1 className="text-base font-semibold leading-6 text-[#202224] text-opacity-60 text-[.875rem]">
                    <time dateTime="2022-01">Today</time>
                </h1>
                <div className="relative flex items-center rounded-md bg-white shadow-sm md:items-stretch text-[24px] font-bold">
                    <button
                        type="button"
                        className="flex h-9 w-12 items-center justify-center rounded-l-md  pr-1 text-brand-primary-black hover:text-gray-500 focus:relative md:w-9 md:pr-0 md:hover:bg-gray-50"
                    >
                    ...
                    <button
                        type="button"
                        className="flex h-9 w-12 items-center justify-center rounded-r-md  pl-1 text-brand-primary-black hover:text-gray-500 focus:relative md:w-9 md:pl-0 md:hover:bg-gray-50"
                    >
                ...
                <div className="hidden md:ml-4 md:flex md:items-center">
                    <span className="isolate inline-flex rounded-md shadow-sm text-[12px]">
                        <button
                            type="button"
